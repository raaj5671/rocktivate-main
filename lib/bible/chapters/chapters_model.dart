...
class ChaptersModel extends FlutterFlowModel<ChaptersWidget> {
  ...
  WidgetClassDebugData toWidgetClassDebugData() => WidgetClassDebugData(
        widgetParameters: {
          ...
          'bookid': debugSerializeParam(
            widget?.bookid,
            ParamType.String,
            link:
                'https://app.flutterflow.io/project/rocktivate-supabase-qbw8kn?tab=uiBuilder&page=Chapters',
            searchReference:
                'reference=ShgKEAoGYm9va2lkEgZ3aHEzdHByBAgDIAFQAVoGYm9va2lk',
            name: 'String',
            nullable: true,
          ),
          'bookName': debugSerializeParam(
            widget?.bookName,
            ParamType.String,
            link:
                'https://app.flutterflow.io/project/rocktivate-supabase-qbw8kn?tab=uiBuilder&page=Chapters',
            searchReference:
                'reference=ShoKEgoIYm9va05hbWUSBjBjY2lmZHIECAMgAVABWghib29rTmFtZQ==',
            name: 'String',
            nullable: true,
          )
        }.withoutNulls,
        ...
        link:
            'https://app.flutterflow.io/project/rocktivate-supabase-qbw8kn/tab=uiBuilder&page=Chapters',
        searchReference: 'reference=OghDaGFwdGVyc1ABWghDaGFwdGVycw==',
        widgetClassName: 'Chapters',
      );
}
