...
import 'dart:ui';
import '/index.dart';
import 'free_stuff_widget.dart' show FreeStuffWidget;
...
class FreeStuffModel extends FlutterFlowModel<FreeStuffWidget> {
  ...
  WidgetClassDebugData toWidgetClassDebugData() => WidgetClassDebugData(
        ...
        link:
            'https://app.flutterflow.io/project/rocktivate-supabase-qbw8kn/tab=uiBuilder&page=FreeStuff',
        searchReference: 'reference=OglGcmVlU3R1ZmZQAVoJRnJlZVN0dWZm',
        widgetClassName: 'FreeStuff',
      );
}
