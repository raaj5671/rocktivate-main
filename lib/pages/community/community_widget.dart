...
class _CommunityWidgetState extends State<CommunityWidget>
  ...
  @override
  void didUpdateWidget(CommunityWidget oldWidget) {
                ...
                child: Padding(
                  ...
                  child: FutureBuilder<List<CommunitiesRow>>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      List<CommunitiesRow> gridViewCommunitiesRowList =
                          snapshot.data!;

                      _model.debugBackendQueries[
                              'gridViewCommunitiesRowList_GridView_f2p921ux${gridViewCommunitiesRowList.length > 100 ? ' (first 100)' : ''}'] =
                          debugSerializeParam(
                        gridViewCommunitiesRowList.take(100),
                      ...
                      return GridView.builder(
                        ...
                        itemCount: gridViewCommunitiesRowList.length,
                        itemBuilder: (context, gridViewIndex) {
                          final gridViewCommunitiesRow =
                              gridViewCommunitiesRowList[gridViewIndex];
                          return InkWell(
                              ...
                              context.pushNamed(
                                ...
                                queryParameters: {
                                  'groupLink': serializeParam(
                                    gridViewCommunitiesRow.uuid,
                                    ParamType.String,
                                  ),
                                  'name': serializeParam(
                                    gridViewCommunitiesRow.title,
                                    ParamType.String,
                                  ),
                                }.withoutNulls,
                              );
                                      ...
                                      child: ClipRRect(
                                        ...
                                        child: Image.network(
                                          valueOrDefault<String>(
                                            gridViewCommunitiesRow.tileImage !=
                                                        null &&
                                                    gridViewCommunitiesRow
                                                            .tileImage !=
                                                        ''
                                                ? gridViewCommunitiesRow
                                                    .tileImage
