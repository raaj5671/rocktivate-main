  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          case CommunityRequestsWithFullNameRow:
            return CommunityRequestsWithFullNameRow(data);
          case CommunityMembersWithFullNameRow:
            return CommunityMembersWithFullNameRow(data);
          case MenuItemsRow:
            return MenuItemsRow(data);
          case CommunityMembersRow:
            return CommunityMembersRow(data);
          case PostsviewRow:
            return PostsviewRow(data);
          case ConversationMessagesRow:
            return ConversationMessagesRow(data);
          case MessagesWithSenderRow:
            return MessagesWithSenderRow(data);
          case CountriesRow:
            return CountriesRow(data);
          case PostsRow:
            return PostsRow(data);
          case PropertyRow:
            return PropertyRow(data);
          case CommunityRequestsRow:
            return CommunityRequestsRow(data);
          case CommunitiesRow:
            return CommunitiesRow(data);
          case MessagesRow:
            return MessagesRow(data);
          case FreebiesRow:
            return FreebiesRow(data);
          case CommentsRow:
            return CommentsRow(data);
          case LikesRow:
            return LikesRow(data);
          case NeedsRow:
            return NeedsRow(data);
          case PeopleRow:
